package com.g2inc.scap.library.domain.oval.oval55;
...
/**
 * Implementation of an OVALDefinitionsDocument for OVAL 5.5 
 *
 */
public class DefinitionsDocumentImpl extends DefinitionsDocumentBase
{
	...
	{
		super(doc);
        setDocumentType(SCAPDocumentTypeEnum.OVAL_55);
	}
